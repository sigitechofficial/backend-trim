...
module.exports = function (email,username,orderNumber,packageQty,neverArrive,consolidation,company,createdat) {
  ...
  const supportNumber = '017874854624';  transporter.sendMail(
    {
      from: process.env.EMAIL_USERNAME, // sender address
      to: email, // list of receivers
      subject: `Order arrived at USA Warehouse`, // Subject line
      // text: `Your OTP for Pacifrica Express is ${otp}`, // plain text body

      attachments: a.arrivedAtLocalHub,
      html: `<!DOCTYPE html>
                                              ...
                                              >
                                                <p style="margin: 0">
                                                  ...
                                                  <span
                                                    ...
                                                    #${orderNumber} 
                                                    has safely arrived at our warehouse and is now ready for processing.
                                                </p>
                                              </div>
                                            </td>
                                          </tr>
                                          ...
                                          <tr>
                                            <td class="pad">
                                              ...
                                              >
                                                <p style="margin: 0">
                                                  <strong>
                                                  Please review the order details above to ensure accuracy. 
                                                  If you have any questions or if there are any discrepancies, 
                                                  please don't hesitate to contact our customer support team at 
                                                  ${supportEmail} or ${supportNumber}.
                                                  </strong>
                                                </p>
                                              </div>
                                            </td>
