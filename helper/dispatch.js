...
module.exports = function (email,name,orderNumber,createdAt,packageCount,company,consolidation,address) {
  ...
  const destination = `${address.streetAddress}, ${address.city}, ${address.province}, ${address.country}`;
  ...
  transporter.sendMail(
    {
      ...
      subject: `Your order dispatched from usa warehouse towards delivery address`, // Subject line
      attachments: a.dispatch,
      html: `<!DOCTYPE html>
                                        ...
                                        >
                                          <p style="margin: 0">
                                            ...
                                            <span
                                              ...
                                              >Hi Ahmed :your order #${orderNumber} is currently on route to your specified 
                                              delivery address from our USA warehouse. Our logistics team has carefully 
                                              prepared and packaged your items for their safe journey to you. Please expect their arrival soon.
                                            </span>
                                          </p>
                                        </div>
                                      </td>
