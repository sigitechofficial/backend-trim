  ...
  transporter.sendMail(
    {
      ...
      subject: `PACIFRICA EXPRESS ORDER CREATED MAIL`, // Subject line
      // text: `Your OTP for Pacifrica Express is ${otp}`, // plain text body

      attachments:a.orderCreated,
      html: `<!DOCTYPE html>
                                              ...
                                              >
                                                <p style="margin: 0">
                                                  ...
                                                  <span
                                                    ...
                                                    >Thank you for Creating an order with
                                                    us. We are pleased to confirm that your
                                                    order has been received and is being
                                                    processed. Your order number is
                                                    <span style="color: #000"> Order#</span
                                                    >${orderNumber}. Here are the details of your
                                                    order:
                                                  </span>
                                                </p>
                                              </div>
                                              ...
                                              >
                                                <p style="margin: 0">
                                                  <strong>
                                                    ...
                                                    immediately <br> Your order will be shipped
                                                    soon and you will receive a separate
                                                    email with tracking information. Please
                                                    note that delivery times may vary
                                                    depending on your location and shipping
                                                    method. <br> Thank you for your business. We
